...
export function ElectrocardiogramaHero() {
  return (
    <section
      id="inicio"
    ...
    >
      <div className="mx-auto max-w-[1320px] px-4 pb-10 lg:pb-16">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <div className="relative mx-auto aspect-[4/3] w-full max-w-[580px] overflow-hidden rounded-[28px] shadow-[0_24px_70px_rgba(10,61,73,.12)] ring-1 ring-slate-100 lg:mx-0 lg:aspect-[5/4] lg:max-w-none lg:rounded-[36px]">
              <Image
                src="/images/servicios/electrocardiograma-hero.png"
                alt="Electrocardiograma a domicilio AinovaHealth"
                fill
                priority
          ...
          >
            ...
            {/* Título */}
            <h1 className="mt-4 leading-[1.1] tracking-[-0.02em] lg:mt-5">
              <span className="block text-[28px] font-black text-[#0A3D49] sm:text-[32px] lg:text-[50px]">
                Electrocardiograma
              </span>
              <span className="mt-0.5 block text-[26px] font-black text-[#25D366] sm:text-[30px] lg:text-[48px]">
                a domicilio.
              </span>
            </h1>

            {/* Línea ECG */}
            <div className="mt-4 flex items-center justify-center gap-3 lg:mt-5 lg:justify-start lg:gap-4">
              <div className="h-[2px] w-[72px] rounded-full bg-[#25D366]/80 sm:w-[100px] lg:w-[120px]" />
              <svg
                width="58"
                height="20"
                viewBox="0 0 120 40"
                fill="none"
                className="shrink-0 lg:h-6 lg:w-[70px]"
              >
                <path
            ...
            {/* Descripción */}
            <p className="mx-auto mt-4 max-w-[440px] text-[15px] leading-relaxed text-slate-600 sm:text-[16px] lg:mx-0 lg:mt-6 lg:max-w-[500px] lg:text-[18px]">
              Realiza tu electrocardiograma sin salir de casa, con atención
              profesional y resultados confiables.
            </p>
