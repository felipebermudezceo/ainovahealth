...
export function PediatricsHero() {
  return (
    <section
      id="inicio"
    ...
    >
      <div className="mx-auto max-w-[1320px] px-4 pb-10 lg:pb-16">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-14">
          {/* Imagen — izquierda en desktop, última en móvil */}
          <motion.div
          ...
          >
            <div className="relative mx-auto aspect-[4/3] w-full max-w-[560px] overflow-hidden rounded-[24px] shadow-[0_20px_60px_rgba(15,23,42,.10)] lg:mx-0 lg:aspect-[5/4] lg:max-w-none lg:rounded-[32px]">
              <Image
                src="/images/servicios/pediatria-hero.png"
                alt="Atención pediátrica a domicilio AinovaHealth"
                fill
                priority
          ...
          {/* Texto — derecha en desktop, primero en móvil */}
          <motion.div
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-[420px] text-[16px] leading-relaxed text-slate-600 lg:mx-0 lg:mt-6 lg:max-w-[480px] lg:text-[18px]">
              Atención profesional para tus hijos en la comodidad de tu hogar.
            </p>
